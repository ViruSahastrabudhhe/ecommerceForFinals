...
insert  into `address_book`(`addressBookID`,`accountID`,`profileID`,`recipientName`,`addressCountry`,`addressProvince`,`addressCity`,`addressDistrict`,`addressStreetName`,`addressUnitName`,`addressPostal`,`addressPhoneNum`,`addressCategory`,`addressDateCreated`,`addressDateEdited`,`isDefault`) values (14,43,7,'seller scott','Philippines','','seller city','vendor strict','7676 street','','9111','09122234121','Home','2024-11-27 00:00:00','2024-12-03 00:00:00',0),(78,43,7,'seller scott','Pitcairn','','12','321','321','','123','09122234121','Home','2024-11-30 00:00:00','2024-12-03 00:00:00',1),(87,42,10,'buyer jones','Philippines','Bukidnon','city haus','districto','123 st','','1231','09123456677','Home','2024-12-08 00:51:01',NULL,1),(88,53,11,'buyers 2','Guinea','','GUINEA PAPA','NIYAONG TE','2477 St','','1231','19191919','Home','2024-12-08 13:03:08',NULL,1);
...
insert  into `address_store`(`addressStoreID`,`accountID`,`profileID`,`storeName`,`storeCountry`,`storeProvince`,`storeCity`,`storeDistrict`,`storeStreetName`,`storeUnitName`,`storePostal`,`storePhoneNum`,`storeDateCreated`,`storeDateEdited`) values (4,43,14,'gigamax','Philippines','','123','123','123','123','123','091283','2024-12-01 00:00:00','2024-12-07 19:32:22');
...
insert  into `cart`(`cartID`,`accountID`,`productID`,`cartQuantity`) values (78,42,13,1);
...
insert  into `order_details`(`orderDetailsID`,`accountID`,`sellerProfileID`,`buyerAddressID`,`orderStatus`,`orderTotal`,`paymentMethod`,`datePlaced`,`dateShipped`,`datePaid`,`dateDelivered`,`dateCompleted`) values (18,42,14,87,'Completed',0,'Cash on Delivery','2024-12-08 01:01:55',NULL,NULL,NULL,NULL),(19,42,14,87,'To deliver',1107,'Cash on Delivery','2024-12-08 10:13:09',NULL,NULL,NULL,NULL),(20,53,14,88,'Completed',370332,'Cash on Delivery','2024-12-08 13:03:31',NULL,NULL,NULL,NULL);
...
insert  into `orders`(`orderID`,`accountID`,`productID`,`orderDetailsID`,`orderQuantity`,`orderItemSum`,`orderStatus`) values (28,42,12,18,3,369369,'Completed'),(29,42,22,18,4,492,'Completed'),(30,42,20,19,5,615,'Cancelled'),(31,42,19,19,4,492,'To deliver'),(32,53,11,20,3,963,'Completed'),(33,53,12,20,3,369369,'Completed');
...
insert  into `profiles_buyer`(`buyerProfileID`,`accountID`,`buyerFirstName`,`buyerLastName`,`buyerPicture`,`buyerPhoneNum`,`buyerCountry`,`buyerDateCreated`,`buyerDateEdited`,`isArchived`) values (7,43,'seller','scott','43_pirateAdobeProducts.png','09122234121','Philippines','2024-11-26 00:00:00',NULL,0),(10,42,'buyer','jones','42_test.png','09123456677','Philippines','2024-11-29 00:00:00','2024-12-01 00:00:00',0),(11,53,'buyers','2','53_hot_wheels.jpg','19191919','Jamaica','2024-12-08 13:02:41',NULL,0);
...
insert  into `profiles_seller`(`sellerProfileID`,`accountID`,`storeName`,`storePicture`,`storePhoneNum`,`storeCountry`,`storeDateCreated`,`storeDateEdited`,`isArchived`) values (14,43,'gigamax','43_hot_wheels.jpg','091283','Philippines','2024-12-01 00:00:00',NULL,0),(15,26,'demerin store','26_pirateAdobeProducts.png','123123','Philippines','2024-12-09 19:53:31',NULL,0);
...
CREATE TABLE `wishlist` (
  ...
  `accountID` bigint(20) NOT NULL,
  `productID` bigint(20) NOT NULL,
  PRIMARY KEY (`wishlistID`,`accountID`,`productID`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `wishlist` */

insert  into `wishlist`(`wishlistID`,`accountID`,`productID`) values (7,42,13);
