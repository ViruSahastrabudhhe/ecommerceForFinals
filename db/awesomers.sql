...
insert  into `cart`(`cartID`,`accountID`,`productID`,`cartQuantity`) values (24,53,1,1),(39,42,42,2),(41,42,10,10),(43,42,21,3);
...
CREATE TABLE `order_details` (
  ...
  PRIMARY KEY (`orderDetailsID`,`accountID`,`buyerAddressID`),
  KEY `detailsAccountID` (`accountID`),
  CONSTRAINT `detailsAccountID` FOREIGN KEY (`accountID`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `order_details` */

insert  into `order_details`(`orderDetailsID`,`accountID`,`buyerAddressID`,`orderStatus`,`paymentMethod`,`datePlaced`,`dateShipped`,`datePaid`,`dateDelivered`,`dateCompleted`) values (2,42,83,'To Ship','Cash on Delivery','2024-12-05 00:54:31',NULL,NULL,NULL,NULL),(3,42,83,'To Ship','Cash on Delivery','2024-12-05 00:55:50',NULL,NULL,NULL,NULL),(4,42,83,'To Ship','Cash on Delivery','2024-12-05 00:57:17',NULL,NULL,NULL,NULL),(5,42,83,'To Ship','Cash on Delivery','2024-12-05 01:19:35',NULL,NULL,NULL,NULL);
...
insert  into `orders`(`orderID`,`accountID`,`productID`,`orderDetailsID`) values (10,42,42,4),(11,42,10,4),(12,42,21,4),(13,42,42,5),(14,42,10,5),(15,42,21,5);
