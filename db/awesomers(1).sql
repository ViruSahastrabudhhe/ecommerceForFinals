...
CREATE TABLE `order_details` (
  ...
  `accountID` bigint(20) NOT NULL,
  `storeProfileID` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`orderDetailsID`,`accountID`,`buyerAddressID`,`storeProfileID`),
...
insert  into `order_details`(`orderDetailsID`,`accountID`,`storeProfileID`,`buyerAddressID`,`orderStatus`,`paymentMethod`,`datePlaced`,`dateShipped`,`datePaid`,`dateDelivered`,`dateCompleted`) values (9,42,0,83,'To Ship','Cash on Delivery','2024-12-05 11:46:22',NULL,NULL,NULL,NULL),(10,42,0,83,'To Ship','Cash on Delivery','2024-12-05 11:47:02',NULL,NULL,NULL,NULL);
...
insert  into `orders`(`orderID`,`accountID`,`productID`,`orderDetailsID`) values (16,42,42,9),(17,42,10,9),(18,42,21,9),(19,42,42,10),(20,42,10,10),(21,42,21,10);
